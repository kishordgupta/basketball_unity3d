...
public class Player : MonoBehaviour
{
		...
		public static float speed = 3f + PurchaseManager.playerMovIncrement;
		
		public static float distanceJump = 2f + PurchaseManager.playerJumpIncrement;
		public static float speedJump = 2f + PurchaseManager.playerJumpIncrement;
