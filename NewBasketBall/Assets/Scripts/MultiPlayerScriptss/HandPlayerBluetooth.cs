...
public class HandPlayerBluetooth : MonoBehaviour {
...
public static class RotateAroundPivotExtensionsPlayer
{
	//Returns the rotated Vector3 using a Quaterion
	public static Vector3 RotateAroundPivotPlayer (this Vector3 Point, Vector3 Pivot, Quaternion Angle)
	{
		return Angle * (Point - Pivot) + Pivot;
	}
	//Returns the rotated Vector3 using Euler
	public static Vector3 RotateAroundPivotPlayer (this Vector3 Point, Vector3 Pivot, Vector3 Euler)
	{
		return RotateAroundPivotPlayer (Point, Pivot, Quaternion.Euler (Euler));
	}
	...
	{
 		Me.position = Me.position.RotateAroundPivotPlayer (Pivot, Angle);
	}
	//Rotates the Transform's position using Euler
	public static void RotateAroundPivotPlayer (this Transform Me, Vector3 Pivot, Vector3 Euler)
	{
		Me.position = Me.position.RotateAroundPivotPlayer (Pivot, Quaternion.Euler (Euler));
	}
}
